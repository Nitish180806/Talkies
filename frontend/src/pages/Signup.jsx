    ...
    <div className="flex items-center w-full my-4">
      ...
      <div className="relative flex-1">
        <input
          ...
          className="peer w-full border border-gray-300 rounded-md px-4 pt-5 pb-2 text-gray-900 placeholder-transparent focus:outline-none focus:border-[#21C4D3]"
        />
        <label
          className={`absolute left-4 transition-all bg-white px-1
            ${
              focused[focusKey] || value
                ? "-top-2.5 text-sm text-[#21C4D3]"
        ...
        {placeholder === "Password" && (
          <span
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 cursor-pointer text-[#21C4D3] font-medium select-none"
          >
    ...
    <div className="min-h-screen flex flex-col bg-[#e8fdff]">
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-6">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8">
          <h1 className="text-3xl font-bold text-center mb-6 text-[#21C4D3]">
            Welcome to <span className="text-[#189AA7]">Talkies</span>
          </h1>

          {error && (
            <div className="flex items-center justify-center bg-red-100 border border-red-300 text-red-700 px-4 py-3 rounded-md mb-4 shadow-md animate-fadeIn">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-[#189AA7] text-white font-semibold rounded-full hover:bg-[#21C4D3] transition-colors"
            >
